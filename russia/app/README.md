...
4. Если никто не слушает, голосовая очередь ждет подключения к потоку; генерация текста и аудио происходит только по явному запросу.
